...
class Config:
    ...
    def get_config_from_user(self):
        ...
        parser.add_argument("-init_e_lr", "--init_e_lr", type=float, help="Initial Source Learning Rate", required=False, default=0.001)
        parser.add_argument("-init_d_lr", "--init_d_lr", type=float, help="Initial Target Learning Rate", required=False, default=0.001)
