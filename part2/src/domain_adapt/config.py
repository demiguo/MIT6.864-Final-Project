...
class Config:
    ...
    def get_config_from_user(self):
        ...
        parser.add_argument("-src_batch_size", "--src_batch_size", type=int, help="Source Batch Size", required=False, default=32)
        ...
        parser.add_argument("-init_src_lr", "--init_src_lr", type=float, help="Initial Learning Rate for Source Domain", required=False, default=0.001)
        parser.add_argument("-init_tgt_lr", "--init_tgt_lr", type=float, help="Initial Learning Rate for Target Domain", required=False, default=0.001)
